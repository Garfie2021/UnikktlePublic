...
{
    public static class SP_AdverSearch
    {
            ...
            long UserNo, short BusinessNo, int AdverNo)
        {
            ...
            dbContext.Database
                .ExecuteSqlRaw("EXECUTE usr.spAdverSearch_Get無料Count_自分を除く @UserNo, @BusinessNo, @AdverNo, @Count OUTPUT",
            ...
            long UserNo)
        {
            ...
            dbContext.Database
                .ExecuteSqlRaw("EXECUTE usr.spAdverSearch_Get無料Count @UserNo, @Count OUTPUT",
                new SqlParameter("@UserNo", UserNo),
                outPara);
        ...
        public static List<AdverSearchSelect> Select(ApplicationDbContext dbContext,
            long UserNo, short BusinessNo)
        {
            return dbContext.AdverSearchSelect
                .FromSqlRaw("EXECUTE usr.spAdverSearch_Select @UserNo, @BusinessNo",
                new SqlParameter("@UserNo", UserNo),
                new SqlParameter("@BusinessNo", BusinessNo))
                .ToList();
        }
            ...
            long UserNo, short BusinessNo, long No)
        {
            return dbContext.Adver
                .FromSqlRaw("EXECUTE usr.spAdverSearch_SelectOne @UserNo, @BusinessNo, @No",
                new SqlParameter("@UserNo", UserNo),
                new SqlParameter("@BusinessNo", BusinessNo),
			...
			int AdvertisingBudget)
        {
            ...
            dbContext.Database
                .ExecuteSqlRaw("EXECUTE usr.spAdverSearch_Insert @UserNo, @BusinessNo, @Valid, @Category, @AdverName, @AdverTitle1, @AdverTitle2, @AdverURL, @AdvertisingBudget, @No OUTPUT",
                new SqlParameter("@UserNo", UserNo),
                new SqlParameter("@BusinessNo", BusinessNo),
        ...
        {
            dbContext.Database
                .ExecuteSqlRaw("EXECUTE usr.spAdverSearch_Update @UserNo, @BusinessNo, @No, @Valid, @Category, @AdverName, @AdverTitle1, @AdverTitle2, @AdverURL, @AdvertisingBudget",
                new SqlParameter("@UserNo", UserNo),
                new SqlParameter("@BusinessNo", BusinessNo),
                new SqlParameter("@No", No),
                new SqlParameter("@Valid", Valid),
        ...
        {
            dbContext.Database
                .ExecuteSqlRaw("EXECUTE usr.spAdverSearch_Delete @UserNo, @BusinessNo, @No",
                new SqlParameter("@UserNo", UserNo),
                new SqlParameter("@BusinessNo", BusinessNo),
                new SqlParameter("@No", No)
                );
