...
{
    public static class SP_AdverRelationClickHistory
    {
            ...
            out string email)
        {
            ...
            dbContext.Database
                .ExecuteSqlRaw("EXECUTE [usr].[spAdverRelationClickHistory_Insert] @UserNo, @BusinessNo, @AdverNo, @WordNo, @ClickUserNo, @ClickUserIP, @Email OUTPUT",
