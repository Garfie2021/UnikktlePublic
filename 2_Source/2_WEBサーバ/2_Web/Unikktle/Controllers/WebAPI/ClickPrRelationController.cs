...
namespace Unikktle.Controllers
{
    [Route("[controller]")]
    [ApiController]
    public class ClickPrRelationController : ControllerBase
    {
        ...
        public ClickPrRelationController(
        ...
        // b: bid: BusinessNo
        // w: wid: WordNo
        [HttpGet(Name = "GetClickPrRelation")]
        public async Task Get(long? u, short? b, int? a, long? w)
        {
            try
            {
                ...
                SP_AdverRelationClickHistory.Insert(_dbContext,
                    (long)u, (short)b, (int)a, (long)w, 
