...
{
    public partial class BusinessModel : PageModel
    {
        ...
        public List<BusinessSelect> BusinessList { get; set; }
        ...
        public async Task<IActionResult> OnGetAsync()
        {
            try
            {
                ...
                BusinessList = SP_Business.Select(_dbContext, userNo);
        ...
        public async Task<IActionResult> OnPostDeleteAsync(short? id)
        {
            try
            {
                ...
                SP_Business.Delete(_dbContext, userNo, (short)id);
