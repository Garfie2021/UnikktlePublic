...
{
    public partial class CreditModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetAsync()
        {
            try
            {
                ...
                OwnedCredit = SP_UserSetting.GetOwnedCredit(_dbContext, userNo);
                CreditHistory = SP_CreditHistory.SelectUserNo(_dbContext, userNo);
