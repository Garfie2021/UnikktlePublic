        ...
        public async Task<IActionResult> OnGetAsync()
        {
            try
            {
                ...
                Input = new InputModel_Index
                {
                    ...
                    Email = userSettingProfile.Email,
                    Nickname = userSettingProfile.Nickname,
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            try
            {
                ...
                SP_UserSetting.UpdateProfile(_dbContext, userNo,
                    Input.Email, Input.Nickname, Input.Gender, (DateTime)Input.BirthDate, Input.Career);

                await _signInManager.RefreshSignInAsync(user);

                // "Your profile has been updated"
                HttpContext.Session.SetString(SessionKey.StatusMessage, _sharedLocalizer["14"]);
