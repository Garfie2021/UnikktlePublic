...
{
    public static class BulkCopy_CollectTargetKeyword_Yahoo_Tmp
    {
        public static DataTable Data;

        static BulkCopy_CollectTargetKeyword_Yahoo_Tmp()
        {
            Data = new DataTable("tmp.tTmpCollectTargetKeywordYahoo");
        ...
        public static void Add(
            ...
            DateTime 登録日時更新日時)
        {
            //if (Data.Select($"SearchKeywordNo = {collectYahooRow.SearchKeywordNo} AND SearchDate = #{collectYahooRow.SearchDate}# AND SearchResultNo = {collectYahooRow.SearchResultNo} AND KeywordNo = {keywordRow.No}").Length < 1)
            //{
            //    Data.Rows.Add(collectYahooRow.SearchKeywordNo, collectYahooRow.SearchDate, collectYahooRow.SearchResultNo, keywordRow.No,
        ...
        public static void Flush(string connectionString)
        {
            ...
            {
                bulkcopy.DestinationTableName = "tmp.tTmpCollectTargetKeywordYahoo";
