...
{
    public static class BulkCopy_CollectTargetKeyword_Bing_Tmp
    {
        public static DataTable Data;

        static BulkCopy_CollectTargetKeyword_Bing_Tmp()
        {
            Data = new DataTable("tmp.tTmpCollectTargetKeywordBing");
        ...
        public static void Add(
            ...
            DateTime 登録日時更新日時)
        {
            //if (Data.Select($"SearchKeywordNo = {collectBingRow.SearchKeywordNo} AND SearchDate = #{collectBingRow.SearchDate}# AND SearchResultNo = {collectBingRow.SearchResultNo} AND KeywordNo = {keywordRow.No}").Length < 1)
            //{
            //    Data.Rows.Add(collectBingRow.SearchKeywordNo, collectBingRow.SearchDate, collectBingRow.SearchResultNo, keywordRow.No,
        ...
        public static void Flush(string connectionString)
        {
            ...
            {
                bulkcopy.DestinationTableName = "tmp.tTmpCollectTargetKeywordBing";
