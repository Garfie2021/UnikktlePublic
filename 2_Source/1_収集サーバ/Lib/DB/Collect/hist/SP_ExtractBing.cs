...
{
    public static class SP_ExtractBing
    {
        private static SqlCommand cmdSelect_MeCabState0;
        private static SqlCommand cmdUpdate_MeCabState;

        static SP_ExtractBing()
        {
            cmdSelect_MeCabState0 = new SqlCommand("hst.sp3ExtractBing_Select_MeCabState0");
            ...
            cmdUpdate_MeCabState = new SqlCommand("hst.sp3ExtractBing_Update_MeCabState");
        ...
        public static List<ExtractBingRow> Select_MeCabState0(SqlConnection cn,
            ...
            out long Cnt英語)
        {
            ...
            // DataTableをListに入れ替え
            var list = new List<ExtractBingRow>();
            foreach (DataRow row in table.Rows)
            {
                list.Add(new ExtractBingRow()
                {
        ...
        public static void Update_MeCabState(SqlConnection cn,
            ExtractBingRow extractBingRow, State MeCabState, string MeCab名詞)
        {
            cmdUpdate_MeCabState.Connection = cn;
            cmdUpdate_MeCabState.Parameters["SearchKeywordNo"].Value = extractBingRow.SearchKeywordNo;
            cmdUpdate_MeCabState.Parameters["SearchDate"].Value = extractBingRow.SearchDate;
            cmdUpdate_MeCabState.Parameters["SearchResultNo"].Value = extractBingRow.SearchResultNo;
