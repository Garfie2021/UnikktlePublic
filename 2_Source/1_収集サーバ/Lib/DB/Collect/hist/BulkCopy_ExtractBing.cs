...
{
    public static class BulkCopy_ExtractBing
    {
        public static DataTable Data;

        static BulkCopy_ExtractBing()
        {
            Data = new DataTable("hst.t3ExtractBing");
        ...
        public static void Flush(string connectionString)
        {
            ...
            {
                bulkcopy.DestinationTableName = "hst.t3ExtractBing";
