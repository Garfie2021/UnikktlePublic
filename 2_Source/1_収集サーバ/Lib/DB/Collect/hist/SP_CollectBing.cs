...
{
    public static class SP_CollectBing
    {
        ...
        static SP_CollectBing()
        {
            cmdSelect_State0 = new SqlCommand("hst.sp1CollectBing_Select_State0");
            cmdSelect_State0.CommandType = CommandType.StoredProcedure;
            cmdSelect_State0.CommandTimeout = DBConst.CommandTimeout_1h;

            cmdSelect_CutoutStateUrl0 = new SqlCommand("hst.sp1CollectBing_Select_UrlState0");
            ...
            cmdUpdate_State = new SqlCommand("hst.sp1CollectBing_Update_State");
            ...
            cmdUpdate_CutoutStateUrl = new SqlCommand("hst.sp1CollectBing_Update_UrlState");
            ...
            cmdTruncate = new SqlCommand("hst.sp1CollectBing_Truncate");
        ...
        public static DataTable Select_State0(SqlConnection cn)
        {
            ...
            //// DataTableをListに入れ替え
            //var list = new List<CollectBingRow>();
            //foreach (DataRow row in table.Rows)
            //{
            //    list.Add(new CollectBingRow()
            //    {
