...
{
    public static class BulkCopy_CollectGoogle
    {
        public static DataTable Data;

        static BulkCopy_CollectGoogle()
        {
            Data = new DataTable("hst.t1CollectGoogle");
        ...
        public static void Flush(string connectionString)
        {
            ...
            {
                bulkcopy.DestinationTableName = "hst.t1CollectGoogle";
