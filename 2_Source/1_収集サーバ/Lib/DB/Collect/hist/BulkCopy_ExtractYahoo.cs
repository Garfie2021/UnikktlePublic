...
{
    public static class BulkCopy_ExtractYahoo
    {
        public static DataTable Data;

        static BulkCopy_ExtractYahoo()
        {
            Data = new DataTable("hst.t3ExtractYahoo");
        ...
        public static void Flush(string connectionString)
        {
            ...
            {
                bulkcopy.DestinationTableName = "hst.t3ExtractYahoo";
