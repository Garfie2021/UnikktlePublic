...
IF OBJECT_ID(N'[hst].[sp3ExtractYahoo_Select_MeCabState0]', N'P') IS NOT NULL
	DROP PROCEDURE [hst].[sp3ExtractYahoo_Select_MeCabState0]
GO
...
CREATE PROCEDURE [hst].[sp3ExtractYahoo_Select_MeCabState0]
