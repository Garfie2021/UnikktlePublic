...
/****** Object:  Job [UnikktleCollect_ã¶í≤ÉtÉBÉãÉ^ÉäÉìÉO]    Script Date: 2019/08/30 10:10:27 ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [[Uncategorized (Local)]]    Script Date: 2019/08/30 10:10:27 ******/
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'UnikktleCollect_ã¶í≤ÉtÉBÉãÉ^ÉäÉìÉO', 
		@enabled=1, 
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [start]    Script Date: 2019/08/30 10:10:27 ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'start', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [[job].[spExecHistory_Insert]]    Script Date: 2019/08/30 10:10:27 ******/
...
', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [[hst].[spInsertCollaborateKeyword_Yahoo]]    Script Date: 2019/08/30 10:10:27 ******/
...
', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [[hst].[spInsertCollaborateKeyword_Bing]]    Script Date: 2019/08/30 10:10:27 ******/
...
', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [[hst].[spInsertCollaborateKeyword_Mail]]    Script Date: 2019/08/30 10:10:27 ******/
...
', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [[hst].[spInsertCollaborateKeyword_Google]]    Script Date: 2019/08/30 10:10:28 ******/
...
', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [[hst].[spInsertCollaborateKeyword]]    Script Date: 2019/08/30 10:10:28 ******/
...
', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [[mst].[spKeyword_Export]]    Script Date: 2019/08/30 10:10:28 ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'[mst].[spKeyword_Export]', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [[hst].[sp7CollaborateKeyword_Export]]    Script Date: 2019/08/30 10:10:28 ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'[hst].[sp7CollaborateKeyword_Export]', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [hst.sp1CollectÅZÅZÅZ_Delete]    Script Date: 2019/08/30 10:10:28 ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'hst.sp1CollectÅZÅZÅZ_Delete', 
		@step_id=10, 
		@cmdexec_success_code=0, 
		@on_success_action=3, 
		@on_success_step_id=0, 
...
', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [[job].[spExecHistory_Update_EndDate]]    Script Date: 2019/08/30 10:10:28 ******/
...
', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [end]    Script Date: 2019/08/30 10:10:28 ******/
